...
use crate::constants::{
    params::{
        HASH_PREFIX_MERKLE_TREE, PARAM_DIGEST_SIZE, PARAM_MERKLE_TREE_HEIGHT,
        PARAM_MERKLE_TREE_NODES,
    },
...
/// Recalculates the merkle root from the commitments and the authentication path
pub fn get_root_from_auth_path(
    auth_path: &mut Vec<Hash>,
    commitments: &[Hash],
    selected_leaves: &[u16],
    salt: Option<Hash>,
...
#[inline(always)]
pub fn merkle_hash(parent_index: usize, left: &Hash, right: &Hash, salt: Option<Salt>) -> Hash {
