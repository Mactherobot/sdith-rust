...
fn gf256_ext16_mul32(a: (u8, u8)) -> (u8, u8) {
    let (a0, a1) = a;
...
pub(crate) fn gf256_ext32_add(a: (u8, u8, u8, u8), b: (u8, u8, u8, u8)) -> (u8, u8, u8, u8) {
    let (a0, a1, a2, a3) = a;
    let (b0, b1, b2, b3) = b;
...
pub(crate) fn gf256_ext32_mul(a: (u8, u8, u8, u8), b: (u8, u8, u8, u8)) -> (u8, u8, u8, u8) {
    let (a0, a1, a2, a3) = a;
    let (b0, b1, b2, b3) = b;
