...
use beaver::{generate_beaver_triples, BeaverA, BeaverB, BeaverC};
...
impl MPC {
    pub fn generate_beaver_triples(prg: &mut PRG) -> (BeaverA, BeaverB, BeaverC) {
        generate_beaver_triples(prg)
    }

    pub fn expand_mpc_challenges(h1: Hash, n: usize) -> Vec<Challenge> {
    ...
    pub fn expand_view_challenge_hash(digest: Hash) -> [[u16; PARAM_L]; PARAM_TAU] {
