...
\label{sec:syndrome}
The basis for the SD-in-the-Head protocol is to use the Syndrome Decoding (SD) problem in order to prove that the signature is correct.
It uses a variant of the SD problem, in the \textit{coset weights} problem, as was defined in 1978 by Berlekamp and McEliece \cite{berlekamp1978inherent}.
