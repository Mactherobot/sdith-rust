...
\begin{protocol}[SD-in-the-Head Signing Protocol]
            ...
            \item compute input shares for $i \in [N]$
                  \begin{align*}
                    ...
                    \begin{cases}
                      ...
                      \text{Share}(i, \texttt{input\_plain}, \texttt{input\_coef}_1^e, \dots, \texttt{input\_coef}_\ell^e) \quad i > 1
                    \end{cases}
                  \end{align*}
  ...
  \paragraph{Phase 5} Building of the signature output the signature $\sigma$. For each $e \in [\tau]$ 
  \begin{enumerate}[itemsep=0pt, topsep=0pt, parsep=0pt]
    \item Compute solution shares $
  \end{enumerate}
