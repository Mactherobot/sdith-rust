...
Why is Rust a good choice for our implementation?

Before diving into the details of our implementation, it is important to first explore the various aspects of the Rust programming language that we leverage to optimize, test, and refine our code.

Introduce the rust lang books: Main book, Effective rust, Performance Book

% https://nnethercote.github.io/perf-book/inlining.html
\subsection{Borrow checker} % mut references
