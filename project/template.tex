...
In this section we will discuss our process when finalizing the implementation. We had a few bugs that led us to setup our code to be comparable with the reference implementation. First we will discuss our implementations of the signing and verification algorithms, and then go into how we tested these. Lastly we will discuss how we used the reference implementation to iron out the bugs in our implementation.
