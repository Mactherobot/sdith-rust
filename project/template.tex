...
First we go through the helper methods that are used to do the computations. Then we describe the creation of beaver triples and finally the whole MPC computations.
