...
\subsection{Testing the MPC Simulation}
...
We then create a simple toy example computation that should be easier to follow due to the randomness being just 1:
\begin{minted}{rust}
