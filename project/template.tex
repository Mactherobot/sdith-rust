...
\begin{figure}
  ...
  \begin{tabular}{l|l|lll}
    ...
    Category & Optimisation  & Keygen          & Sign        & Verify          \\
    \hline
    One      & Reference          & $1090$ $\mu$s & $2.65$ ms & $380$ $\mu$s \\
    ...
    Three   & Reference         & $1280$ ms & $6.37$ ms & $1.16$ ms \\
    ...
    Five   & Reference         & $2230$ $\mu$s & $13.71$ ms & $2.08$ ms \\
    ...
    \hline
  \end{tabular}
  \caption{API benchmarks over each category and optimisation feature flag for setup 2}\label{fig:api_benchmarks_mac}
\end{figure}
