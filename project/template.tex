...
\subsection{Witness generation}\label{sub:witness_generation} % (fold)
In order to create a public and private key pair, we need a witness for the syndrome decoding instance. As presented in the \autoref{eq:polynomial_representation} we need to create a set of polynomials that is based upon   a matrix $H$.
