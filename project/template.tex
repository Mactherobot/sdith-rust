...
This technique comes in handy as we can also allow the user to specify a custom set of parameters. We do this by introducing an extra feature flag, \texttt{category\_custom}. Connected with an environment variable, \texttt{SDITH\_CUSTOM\_PARAMS\_PATH}, we can conditionally load the custom parameters file
