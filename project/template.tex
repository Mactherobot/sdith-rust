...
To ensure memory safety, Rust uses a borrow checker to prevent data races and memory leaks. This system ensures that references to data are valid and do not outlive the data they refer to. By enforcing strict ownership rules, Rust helps prevent common programming errors such as double-free or use-after-free. 
