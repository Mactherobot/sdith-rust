...
\begin{itemize}
  \item spec implementation results
  \item no features, simd, parallel, parallel and simd - TB off for all
  \item run theirs and ours full optimisation with TB
  \item nightly vs stable
  \item multiplication algorithms: Individually and in whole protocol
  \item dudect bench (bunch of times to get a good average)
  \item blake3 vs keccak
  \item signature size
\end{itemize}
