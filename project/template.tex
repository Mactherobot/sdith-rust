...
Before going into details about our implementation, it stands to reason to explain the different facets of the Rust programming language that we use to optimise, test and "beautify" our code.
