...
Pre-processing in MPC is a technique that relies on shares of correlated randomness -- say randomness
...
\begin{itemize}
  ...
  \item \textbf{MacBook Pro (M2 Pro)}:
    ...
    \end{itemize}
\end{itemize}
This setup provided a diverse testing environment, ensuring our benchmarks accounted for both x86_64 and ARM architectures.
