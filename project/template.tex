...
As stated earlier, we wanted to implement the underlying arithmetic our selves and not rely on a crate for the arithmetic of the field. This led us to implement the galois field arithmetic.
We did this by creating a trait for field arithmetic, with the 
