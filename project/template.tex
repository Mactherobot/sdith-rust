...
\end{minted}
\noindent Note here that we have a conversion to and from the SIMD type, yet it still yielded a better performance. This might indicate that even more sophisticated SIMD optimisations could be beneficial for improving performance. 
