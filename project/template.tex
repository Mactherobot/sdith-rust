...
\subsection{In choosing the SD-in-the-Head protocol}
The SD-in-the-Head protocol offers a highly modular design which allows for a wide range of subroutines and configurability. This configurability is especially showcased in the two variants covered by the specification; the \textit{hypercube} and \textit{threshold} variants which show 

\subsection{In choosing Rust}
