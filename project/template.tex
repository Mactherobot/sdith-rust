...
\section{Syndrome Detection Problem}
\label{sec:syndrome}

Describe the the syndrome detection problem introducing why we need ZKAoK, LSSS, Beaver triples and MPC construction from \cite{baum2020concretely} section 3.3.
...
\todo{Describe the arithmetic operations in GF256}
...
\begin{figure}
  \makebox[\textwidth]{
    ...
    \fbox{\begin{minipage}[t]{.45\textwidth}
        ...
        \end{flalign*}
      \end{minipage}}}
  \caption{Simplified version of the MPC party computation and inverse computation.}
  \label{fig:mpc}
\end{figure}
\bigskip
