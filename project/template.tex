...
As mentioned before in the \autoref{sub:field_arithmetic} we have a trait for the required field operations, so we can implement those on the type $FPoint$. First we implemented the addition which is again a simple XOR operation on each component. 
