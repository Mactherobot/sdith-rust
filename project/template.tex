...
The prover sends this to the verifier whenever he wants to open a value. The verifier can check that the commitment is correct by recomputing the root using the authentication path and the leaf value.
