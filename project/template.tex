...
To validate the correctness of the Merkle tree implementation, we perform the following steps (see test \rust{fn test_new_merkle_tree} in \texttt{src/subroutines/merkle\_tree.rs}):
...
As per usual by now, we implemented this as a feature flag \texttt{merkle\_batching} and conditionally compiled it in. The batching approach yielded a modest performance improvement.
