...
After ipmlementing the environment variables, we realised that we could also use feature flags to change the category. This is done by adding the following to the Cargo.toml file.
\begin{minted}{rust}
[features]
