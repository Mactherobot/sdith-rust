...
\end{minted}
Instead of looping through the date we can use SIMD to do the operation in one go:
\begin{minted}{rust}
...
\begin{figure}
  \centering
\caption{API benchmarks over Categories, Configurations, With/Without Optimizations}\label{fig:api_benchmarks}
\end{figure}
